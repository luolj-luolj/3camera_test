...
class ImageReader {
 public:
   ...
   * Ctor and Dtor()
   */
  explicit ImageReader(ImageFormat* res, enum AIMAGE_FORMATS format, int camId, int S);
  ...
  */
  ...
  void BufferCallback(AImageReader* reader, AHardwareBuffer* buffer);
 ...
 private:
  ...
  void saveTofRawData(AImage* image);
